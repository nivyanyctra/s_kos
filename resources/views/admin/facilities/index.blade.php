                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        @if ($facility->image_path)
                            <img src="{{ asset('storage/' . $facility->image_path) }}" class="card-img-top"
                                alt="{{ $facility->name }}" style="height:200px; object-fit:cover;">
                        @endif
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto d-flex flex-column gap-2">
                                ...
                                <form id="delete-form-{{ $facility->id }}"
                                    action="{{ route('admin.facilities.destroy', $facility->id) }}" method="POST"
                                    class="w-100">
                                    @csrf
                                    @method('DELETE')
